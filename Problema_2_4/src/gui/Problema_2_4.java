...
public class Problema_2_4 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		Obrero o = new Obrero(124, "now", 40, 80);
		
		listado(o);
		o.setHorasTrabajadas(o.getHorasTrabajadas() + 8);
		o.setTarifaHora(o.getTarifaHora()*0.985);
		listado(o);
	}
	//  M�todos tipo void (con par�metros)
	public void listado(Obrero x) {
		...
		imprimir("Descuento por AFP: " + x.descAFP());
		imprimir("Descuento por EPS: " + x.descEPS());
